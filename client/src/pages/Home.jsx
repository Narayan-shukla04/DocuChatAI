...
const features = [
  {
    ...
    description: 'Support for PDF, DOCX, TXT, Excel, and PPTX files. Just drag and drop.',
  },
  {
    icon: <MessageSquare className="w-6 h-6 text-secondary" />,
    title: 'Smart Chat',
    description: 'Context-aware AI that answers questions based precisely on your documents.',
  },
  {
    icon: <Zap className="w-6 h-6 text-accent" />,
    title: 'Lightning Fast',
    description: 'Powered by advanced RAG pipelines and vector databases for instant retrieval.',
  },
  {
    ...
    <div className="min-h-screen bg-dark-bg text-text-main selection:bg-primary selection:text-white">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Upload any PDF, Excel, Word, or PowerPoint file and get instant answers, summaries, and insights using advanced AI.
          </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-text-muted max-w-2xl mx-auto text-lg">
              Powerful features designed to help you extract knowledge from your files effortlessly.
            </p>
          </div>
