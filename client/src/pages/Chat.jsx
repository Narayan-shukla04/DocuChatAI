    ...
    <div className="flex flex-col h-screen bg-dark-bg text-text-main">
      ...
      <main className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-6">
        {isLoadingHistory ? (
          ...
          <div className="h-full flex flex-col items-center justify-center text-center max-w-lg mx-auto text-text-muted">
            ...
            <p>
              Ask me anything about your document. I can summarize, extract key
                      ...
                      components={{
                        code({ inline, className, children, ...props }) {
                          ...
                          return !inline && match ? (
                            ...
                            <code
                              className="bg-dark-bg/50 px-1 py-0.5 rounded text-sm font-mono text-accent"
                              {...props}
                            >
                              {children}
                            </code>
      ...
      <footer className="p-4 sm:p-6 max-w-4xl mx-auto w-full">
        ...
        <p className="text-center text-xs text-text-muted mt-3">
          DocuChat AI can make mistakes. Consider verifying important
          information.
        </p>
      </footer>
    </div>
